...
void mmult_task(int argc, char *argv[])
{
    ...
    if (argc != 2)
    {
        cerr << "Usage: 1_mmult.exe arraySize [default is 1024].\n";
        num = 1024;
    }
    else
    {
    ...
    cout << "Elapsed time simple = " << (chrono::duration_cast<chrono::milliseconds>(stop - start).count()) << " mseconds" << endl;
    ...
    cout << "Elapsed time seq = " << (chrono::duration_cast<chrono::milliseconds>(stop - start).count()) << " mseconds" << endl;
    ...
    cout << "Elapsed time blocked = " << (chrono::duration_cast<chrono::milliseconds>(stop - start).count()) << " mseconds" << endl;
